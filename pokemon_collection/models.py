...
class Pokemon(db.Model):
    ...
    def from_dict(self, pokedict):

        self.id = pokedict['id']
        self.name = pokedict['name']
        self.description = pokedict['description']
        self.image = pokedict['image']
        self.type = pokedict['type']
        self.ability = pokedict['ability']
        self.height = pokedict['height']
        self.weight = pokedict['weight']
